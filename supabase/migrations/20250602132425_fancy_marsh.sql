...
DROP POLICY IF EXISTS "Trigger can create user profile" ON profiles;
...
DROP POLICY IF EXISTS "Users can create questions for their interviews" ON questions;
...
DROP POLICY IF EXISTS "Users can view feedback for their interviews" ON feedback;
...
DROP POLICY IF EXISTS "Users can access their own CVs" ON storage.objects;
