        ...
        <div className="text-center space-y-12">
          ...
          >
            <Link href="/register">
              <Button
                size="lg"
                className="relative px-10 py-7 text-xl font-bold rounded-2xl overflow-hidden bg-gradient-to-r from-white to-gray-100 text-gray-900 hover:from-gray-100 hover:to-white transition-all duration-300 shadow-2xl hover:shadow-white/20 hover:scale-105 border border-white/20"
              >
